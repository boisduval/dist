...
const handleZX = function () {
  $("nav.overview").click(function (e) {
    ...
    //  隐藏所有内容
    $(".home-overview-main .section").hide();

    const index = e.target.dataset.index * 1 + 2;
    $(`.home-overview-main .section:nth-child(${index})`).show();
  ...
  let data = [
    {
      ...
      date: "2022-03-26",
      content:
        "11月18日，江门新会区庆祝2021年中国农民丰收节暨新会大红柑采摘活动在新会柑之林梅江种植示范基地成功举办，为新会柑种质资源中心今年刚采收的道地新会柑皮举行封箱仪式。目前，新会全区种植新会柑约10万亩，形成药、…",
    },
    {
      title: "江门新会大红柑正式采摘！新会陈皮全产业链产值超…",
      date: "2022-03-12",
  ...
  let data = [
    {
      ...
      date: "2022-03-26",
      content:
        "     为深入贯彻落实习近平新时代中国特色社会主义思想和习近平总书记对技能人才工作的重要指示批示精神，按照市委关于“人才…",
    },
    {
      title: "2022年江门市“侨都十大工匠”“侨都百优…",
      date: "2022-03-26",
  ...
  let data = [
    {
      ...
      content:
        "\t近期，广东多地受到暴雨持续影响，江门市新会区也迎来持续雨水天气。目前正值10万亩新会柑保果保树的敏感期和关键期，为做好新会柑树防护和雨后管理工作，新会区农业农村局、新会陈皮产业发展中心和新会陈皮行业协会及时发出柑树管护通知，并组织人员走访柑园掌握相关落实情况，总体上看，各柑园暂未受到明显影响。\n" +
